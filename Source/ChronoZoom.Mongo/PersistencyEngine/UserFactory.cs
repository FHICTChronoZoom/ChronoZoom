...
namespace ChronoZoom.Mongo.PersistencyEngine
{
    public class UserFactory
    {
        ...
        /// <returns></returns>
        public async Task<Boolean> InsertAsync(User user) 
        {
            var collection = MongoFactory.database.GetCollection<User>(COLLECTION_NAME);
        ...
        public async Task<Boolean> UpdateAsync(User user) 
        {
        ...
        public async Task<Boolean> DeleteAsync(Guid userId) 
        {
            var collection = MongoFactory.database.GetCollection<User>(COLLECTION_NAME);
            var deleteResult = await collection.DeleteOneAsync<User>(x => x.Id.Equals(userId));
